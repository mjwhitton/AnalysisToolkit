...
private void run(String test) throws IOException, Exception{
    ...
    else if(test.equals("TestReadCsv - testNewExtractFileSelect"))
    {
    Toolkit.TestReadCsv trc = new Toolkit.TestReadCsv();
    trc.testNewExtractFileSelect();
    }
    else if(test.equals("TestGetDOIs - testGetDOIs"))
    {
    API_tools.TestGetDOIs gd = new API_tools.TestGetDOIs();
    gd.testGetDOIs();
    }
